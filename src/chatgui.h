...
private:
    ...
    //HM//ChatLogic *_chatLogic;
    std::unique_ptr<ChatLogic> _chatLogic; //HM  create a unique pointer on the stack
...
public:
    ...
    // getter / setter
     ...
     ChatLogic *GetChatLogicHandle() { return _chatLogic.get(); } //HM: .get()
