    ...
    : wxScrolledWindow(parent, id)
{
   ...
   //HM// _chatLogic = new ChatLogic(); 
	 _chatLogic=std::make_unique<ChatLogic>(); // HM create a unique pointer on the stack
